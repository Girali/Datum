Shader"OccaSoftware/Altos/TemporalAA"
{
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 Fragment(Varyings input) : SV_Target
            {
                ...
                float2 motionVectors = GetMotionVector(input.uv);
                return TemporalAA(_PREVIOUS_TAA_CLOUD_RESULTS, _CURRENT_TAA_FRAME, input.uv, _TAA_BLEND_FACTOR, motionVectors);
            }
            ENDHLSL
        }
    }
